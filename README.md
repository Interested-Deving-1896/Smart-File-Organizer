...
Run the [Check Accessibility](https://github.com/Interested-Deving-1896/Smart-File-Organizer/actions/workflows/check-accessibility.yml)
workflow to generate the first report and accessibility artifacts.
See [DOCS/accessibility.md](https://github.com/Interested-Deving-1896/Smart-File-Organizer/blob/main/DOCS/accessibility.md) for the full reference.
